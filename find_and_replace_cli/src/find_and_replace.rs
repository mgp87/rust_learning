// cargo modules structure --> generates a tree of files amongst other options including types
...
fn print_help() {
    eprintln!("{} - replace a string with a new string", "Find and Replace".green()); // error and progress messages
